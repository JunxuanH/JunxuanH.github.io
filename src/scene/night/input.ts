...
export function createInput(opts: InputOptions) {
  ...
  const onKeyDown = (e: KeyboardEvent) => {
    ...
    if (e.code === 'KeyF' || e.code === 'Enter') { interact = true; e.preventDefault(); return; }
  ...
  function poll(): InputState {
    if (document.documentElement.classList.contains('resume-open') || document.documentElement.classList.contains('shop-open')) clear();

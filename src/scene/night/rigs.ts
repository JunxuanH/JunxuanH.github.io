...
export const RIG_META: Record<string, Partial<RigMeta>> = {
  'ronin-player': { height: 1.8, stride: 1.483, strideRun: 4.778, groundOffset: .002, groundOffsetRun: .024, groundOffsetIdle: -.0153, headY: 1.567, stepLen: .791, stepLenRun: 1.593, note: 'Selected anime protagonist: silver hair, purple bomber. Hunyuan 3.1 Pro + one Meshy skeleton; 39,757 triangles, no stray weights. Run refined with phase-matched walk poses; stride and grounding re-audited. Idle offset expressed in exported 1.17647x clip units; normalized at runtime.' },
